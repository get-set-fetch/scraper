...
/**
 * Converts a scrape configuration to a deflated based64 string.
...
/**
 * Converts a deflated based64 string to a scrape configuration.
 * @param deflatedBase64String - scrape configuration
 */
